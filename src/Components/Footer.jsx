            ...
            <Container id='footer'>
                <Row className="text-center text-md-left">
                    ...
                    <Col md={6} className="mb-4 mb-md-0">
                        ...
                        <ul className="list-unstyled">
                            <li>
                                <FontAwesomeIcon icon={faEnvelope} /> <a href="mailto:saeedhareez@gmail.com" className="text-decoration-none">saeedhareez@gmail.com</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <FontAwesomeIcon icon={faLinkedin} /> <a href="https://www.linkedin.com/in/saeed-hareez-398685288" target='_blank' className="text-decoration-none">LinkedIn</a>
                            </li>
